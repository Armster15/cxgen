...
def cxgen_license():
    with open("files/LICENSE-for-function.txt") as l: # The with keyword automatically closes the file when you are done
        print (l.read())
def manual():
    with open("files/manual.txt") as m: # The with keyword automatically closes the file when you are done
        print (m.read())

def about():
    print("About cxgen 1.0")
    print()
    print("Created by Armaan Aggarwal on April 7, 2019")
